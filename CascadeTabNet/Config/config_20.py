...
train_dataloader = dict(   # Train dataloader config
    ...
    dataset=dict(  # Train dataset config
        ...
        ann_file=data_root + 'Annotations/train_20.json',  # Path of annotation file
...
default_hooks = dict(checkpoint=dict(type='CheckpointHook', interval=20, by_epoch=True, out_dir='/csehome/m23csa016/MTP/CascadeTabNet/Checkpoints/Data_20'))
