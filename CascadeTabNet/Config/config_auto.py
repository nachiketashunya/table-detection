...
val_evaluator = dict(  # Validation evaluator config
    ...
    ann_file=data_root + 'Annotations/automate/test.json',  # Annotation file path
...
default_hooks = dict(checkpoint=dict(type='CheckpointHook', interval=50, by_epoch=True, out_dir='/csehome/m23csa016/MTP/CascadeTabNet/Checkpoints/Automatic'))
