...
default_hooks = dict(
    checkpoint=dict(
        by_epoch=True,
        interval=30,
        out_dir='/csehome/m23csa016/MTP/CascadeTabNet/Checkpoints/Smudged',
        type='CheckpointHook'),
...
launcher = 'none'
load_from = 'CascadeTabNet/Checkpoints/Smudged/new_config/epoch_100.pth'
log_level = 'INFO'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        backend_args=None,
        data_prefix=dict(img='/scratch/m23csa016/tabdet_data/Smudged'),
        data_root='/scratch/m23csa016/tabdet_data/',
...
work_dir = 'CascadeTabNet/evaluations/Smudged/'
