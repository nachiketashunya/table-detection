...
default_hooks = dict(
    checkpoint=dict(
        by_epoch=True,
        interval=30,
        out_dir='/csehome/m23csa016/MTP/CascadeTabNet/Checkpoints/Dilated',
        type='CheckpointHook'),
...
launcher = 'none'
load_from = 'CascadeTabNet/Checkpoints/Dilated/new_config/epoch_100.pth'
log_level = 'INFO'
...
work_dir = 'CascadeTabNet/evaluations/Dilated/'
