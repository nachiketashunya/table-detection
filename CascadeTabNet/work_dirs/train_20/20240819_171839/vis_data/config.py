...
default_hooks = dict(
    checkpoint=dict(
        by_epoch=True,
        interval=20,
        out_dir='/csehome/m23csa016/MTP/CascadeTabNet/Checkpoints/Data_20',
        type='CheckpointHook'),
...
train_dataloader = dict(
    ...
    batch_size=2,
    dataset=dict(
        ann_file='/scratch/m23csa016/tabdet_data/Annotations/train_20.json',
        backend_args=None,
        data_prefix=dict(img='/scratch/m23csa016/tabdet_data/Orig_Image'),
        data_root='/scratch/m23csa016/tabdet_data/',
...
work_dir = '/csehome/m23csa016/MTP/CascadeTabNet/work_dirs/train_20/'
