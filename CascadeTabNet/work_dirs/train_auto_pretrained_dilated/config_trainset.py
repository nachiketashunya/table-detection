...
default_hooks = dict(
    checkpoint=dict(
        ...
        interval=50,
        out_dir=
        '/scratch/m23csa016/tabdet_data/Checkpoints/Data_AL_Pretrained_Dilated/40.0/TrainSet',
        type='CheckpointHook'),
...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/scratch/m23csa016/tabdet_data/Annotations/automate/train_test.json',
        backend_args=None,
...
train_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/scratch/m23csa016/tabdet_data/Annotations/automate/train_train.json',
        backend_args=None,
        data_prefix=dict(img='/scratch/m23csa016/tabdet_data/Dilated'),
        data_root='/scratch/m23csa016/tabdet_data/',
...
work_dir = 'work_dirs/train_auto_pretrained_dilated'
